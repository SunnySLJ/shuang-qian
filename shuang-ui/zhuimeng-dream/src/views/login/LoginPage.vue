    ...
    <div class="login-container">
      ...
      <div class="login-brand">
        <div class="brand-inner">
          <div class="brand-logo">
            ...
            <div>
              <h1 class="brand-name">追梦 Dream</h1>
      ...
      <div class="login-form-wrapper">
        <div class="login-card glass-card">
          ...
          <!-- 登录表单 -->
          <form v-if="activeTab === 'login'" class="form-body" @submit.prevent="handleLogin" autocomplete="off">
            <div class="form-title">欢迎回来</div>
            <p class="form-subtitle">登录您的追梦 Dream 账户</p>
          ...
          <!-- 注册表单 -->
          <form v-else class="form-body" @submit.prevent="handleRegister" autocomplete="off">
            <div class="form-title">创建账户</div>
            <p class="form-subtitle">加入追梦 Dream，开启 AI 创作之旅</p>
...
import { getLoginUserInfo, login, register } from '@/api/auth'
...
async function handleLogin() {
  ...
  try {
    ...
    // 先保存 token 到 localStorage，否则 getLoginUserInfo 请求无法携带 token
    ...
    store.login(res.accessToken, {
      ...
      avatar: user.avatar || '',
      phone: user.mobile || loginForm.phone,
      level: 0,
...
/* 关键：使用 box-shadow 内阴影覆盖 autofill 的白色背景 - 100px 确保完全覆盖 */
.field-input-wrap .input-dream:-webkit-autofill,
.field-input-wrap .input-dream:-webkit-autofill:hover,
.field-input-wrap .input-dream:-webkit-autofill:focus,
.field-input-wrap .input-dream:-webkit-autofill:active {
  -webkit-box-shadow: 0 0 0 100px rgba(255, 255, 255, 0.04) inset !important;
  box-shadow: 0 0 0 100px rgba(255, 255, 255, 0.04) inset !important;
...
.field-input-wrap .auth-input::placeholder,
.field-input-wrap .auth-input::-webkit-input-placeholder,
.field-input-wrap .auth-input::-moz-placeholder,
.field-input-wrap .auth-input:-ms-input-placeholder {
...
/* autofill 状态下的 placeholder 样式覆盖 */
.field-input-wrap .auth-input:-webkit-autofill::placeholder,
.field-input-wrap .auth-input:-webkit-autofill:hover::placeholder,
.field-input-wrap .auth-input:-webkit-autofill:focus::placeholder {
  color: rgba(255, 255, 255, 0.36) !important;
  font-size: 14px !important;
  font-weight: 500;
  opacity: 1 !important;
