package cn.shuang.module.trade.convert.order;
...
import cn.shuang.framework.common.util.string.StrUtils;
import cn.shuang.framework.dict.core.DictFrameworkUtils;
import cn.shuang.framework.ip.core.utils.AreaUtils;
import cn.shuang.module.member.api.address.dto.MemberAddressRespDTO;
import cn.shuang.module.member.api.user.dto.MemberUserRespDTO;
...
import cn.shuang.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import cn.shuang.module.product.api.sku.dto.ProductSkuRespDTO;
import cn.shuang.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
import cn.shuang.module.product.api.spu.dto.ProductSpuRespDTO;
import cn.shuang.module.promotion.api.combination.dto.CombinationRecordCreateReqDTO;
import cn.shuang.module.trade.api.order.dto.TradeOrderRespDTO;
import cn.shuang.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import cn.shuang.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import cn.shuang.module.trade.controller.admin.order.vo.*;
import cn.shuang.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import cn.shuang.module.trade.controller.app.order.vo.*;
import cn.shuang.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import cn.shuang.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import cn.shuang.module.trade.dal.dataobject.order.TradeOrderLogDO;
import cn.shuang.module.trade.enums.order.TradeOrderItemAfterSaleStatusEnum;
import cn.shuang.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import cn.shuang.module.trade.framework.order.config.TradeOrderProperties;
import cn.shuang.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static cn.shuang.framework.common.util.collection.CollectionUtils.convertMap;
import static cn.shuang.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static cn.shuang.framework.common.util.date.LocalDateTimeUtils.addTime;
