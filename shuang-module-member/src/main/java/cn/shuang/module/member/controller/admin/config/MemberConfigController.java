package cn.shuang.module.member.controller.admin.config;

import cn.shuang.framework.common.pojo.CommonResult;
import cn.shuang.module.member.controller.admin.config.vo.MemberConfigRespVO;
import cn.shuang.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import cn.shuang.module.member.convert.config.MemberConfigConvert;
import cn.shuang.module.member.dal.dataobject.config.MemberConfigDO;
import cn.shuang.module.member.service.config.MemberConfigService;
