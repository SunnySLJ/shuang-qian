package cn.shuang.module.promotion.service.banner;

import cn.shuang.framework.common.pojo.PageResult;
import cn.shuang.module.promotion.controller.admin.banner.vo.BannerCreateReqVO;
import cn.shuang.module.promotion.controller.admin.banner.vo.BannerPageReqVO;
import cn.shuang.module.promotion.controller.admin.banner.vo.BannerUpdateReqVO;
import cn.shuang.module.promotion.convert.banner.BannerConvert;
import cn.shuang.module.promotion.dal.dataobject.banner.BannerDO;
import cn.shuang.module.promotion.dal.mysql.banner.BannerMapper;
...
import static cn.shuang.module.promotion.enums.ErrorCodeConstants.BANNER_NOT_EXISTS;
