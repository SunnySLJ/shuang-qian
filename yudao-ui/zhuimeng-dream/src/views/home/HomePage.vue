  ...
  <div class="home-page">
    ...
    <header class="hero-nav">
      <div class="hero-nav-inner">
        ...
        <div class="hero-nav-actions">
          ...
          <router-link to="/register" class="btn-primary-sm">免费试用</router-link>
        </div>
      </div>
    </header>
      ...
      <div class="section-container">
        <div class="showcase-split">
          <div class="showcase-text">
            ...
            <router-link to="/ai/image" class="btn-hero-primary" style="margin-top: 32px; display: inline-flex;">
              体验图片生成 →
            </router-link>
          </div>
    ...
    <section class="cta-section">
      ...
      <div class="cta-content">
        ...
        <router-link to="/login" class="btn-hero-primary cta-btn">
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M13 2L3 14h9l-1 8 10-12h-9l1-8z"/></svg>
          立即免费体验
        </router-link>
      </div>
