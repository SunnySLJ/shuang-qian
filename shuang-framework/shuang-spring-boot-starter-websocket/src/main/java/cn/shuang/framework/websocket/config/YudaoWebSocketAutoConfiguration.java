package cn.shuang.framework.websocket.config;

import cn.shuang.framework.mq.redis.config.YudaoRedisMQConsumerAutoConfiguration;
import cn.shuang.framework.mq.redis.core.RedisMQTemplate;
import cn.shuang.framework.websocket.core.handler.JsonWebSocketMessageHandler;
import cn.shuang.framework.websocket.core.listener.WebSocketMessageListener;
import cn.shuang.framework.websocket.core.security.LoginUserHandshakeInterceptor;
import cn.shuang.framework.websocket.core.security.WebSocketAuthorizeRequestsCustomizer;
import cn.shuang.framework.websocket.core.sender.kafka.KafkaWebSocketMessageConsumer;
import cn.shuang.framework.websocket.core.sender.kafka.KafkaWebSocketMessageSender;
import cn.shuang.framework.websocket.core.sender.local.LocalWebSocketMessageSender;
import cn.shuang.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageConsumer;
import cn.shuang.framework.websocket.core.sender.rabbitmq.RabbitMQWebSocketMessageSender;
import cn.shuang.framework.websocket.core.sender.redis.RedisWebSocketMessageConsumer;
import cn.shuang.framework.websocket.core.sender.redis.RedisWebSocketMessageSender;
import cn.shuang.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageConsumer;
import cn.shuang.framework.websocket.core.sender.rocketmq.RocketMQWebSocketMessageSender;
import cn.shuang.framework.websocket.core.session.WebSocketSessionHandlerDecorator;
import cn.shuang.framework.websocket.core.session.WebSocketSessionManager;
import cn.shuang.framework.websocket.core.session.WebSocketSessionManagerImpl;
