...
import cn.shuang.module.pay.api.notify.dto.PayRefundNotifyReqDTO;
import cn.shuang.module.pay.api.notify.dto.PayTransferNotifyReqDTO;
...
import static cn.shuang.module.pay.framework.job.config.PayJobConfiguration.NOTIFY_THREAD_POOL_TASK_EXECUTOR;
