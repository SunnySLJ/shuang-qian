 ...
 * @author shuang-pro
 */
@Schema(description = "管理后台 - 教程视频 Response VO")
@Data
public class AiTutorialVideoRespVO {
    ...
    @Schema(description = "视频 URL", example = "https://cdn.fenshen123.com/60/d36d954b524c511a9a155a8b4b3d32.mp4")
