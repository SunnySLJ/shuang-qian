...
-- @formatter:off
BEGIN;
INSERT INTO infra_file_config (id, name, storage, remark, master, config, creator, create_time, updater, update_time, deleted) VALUES (4, '数据库（示例�?, 1, '我是数据�?, '0', '{"@class":"cn.iocoder.yudao.module.infra.framework.file.core.client.db.DBFileClientConfig","domain":"http://127.0.0.1:48080"}', '1', '2022-03-15 23:56:24', '1', '2025-11-24 20:57:14', '0');
...
INSERT INTO system_sms_channel (id, signature, code, status, remark, api_key, api_secret, callback_url, creator, create_time, updater, update_time, deleted) VALUES (4, '测试渠道', 'DEBUG_DING_TALK', 0, '123', 'DEBUG_API_KEY', 'DEBUG_API_SECRET', NULL, '1', '2021-04-13 00:23:14', '1', '2022-03-27 20:29:49', '0');
...
COMMENT ON COLUMN yudao_demo01_contact.birthday IS '出生�?;
COMMENT ON COLUMN yudao_demo01_contact.description IS '简�?;
COMMENT ON COLUMN yudao_demo01_contact.avatar IS '头像';
COMMENT ON COLUMN yudao_demo01_contact.creator IS '创建�?;
COMMENT ON COLUMN yudao_demo01_contact.create_time IS '创建时间';
COMMENT ON COLUMN yudao_demo01_contact.updater IS '更新�?;
...
COMMENT ON COLUMN yudao_demo02_category.creator IS '创建�?;
COMMENT ON COLUMN yudao_demo02_category.create_time IS '创建时间';
COMMENT ON COLUMN yudao_demo02_category.updater IS '更新�?;
...
COMMENT ON TABLE yudao_demo02_category IS '示例分类�?;
...
INSERT INTO yudao_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (3, '怪�?, 0, '1', '2023-11-16 20:24:32', '1', '2023-11-16 20:24:32', '0', 1);
INSERT INTO yudao_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (4, '小番�?, 2, '1', '2023-11-16 20:24:39', '1', '2023-11-16 20:24:39', '0', 1);
INSERT INTO yudao_demo02_category (id, name, parent_id, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (5, '大番�?, 2, '1', '2023-11-16 20:24:46', '1', '2023-11-16 20:24:46', '0', 1);
...
COMMENT ON COLUMN yudao_demo03_course.creator IS '创建�?;
COMMENT ON COLUMN yudao_demo03_course.create_time IS '创建时间';
COMMENT ON COLUMN yudao_demo03_course.updater IS '更新�?;
...
COMMENT ON TABLE yudao_demo03_course IS '学生课程�?;
...
INSERT INTO yudao_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 5, '计算�?, 11, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:44:40', '1', 1);
...
INSERT INTO yudao_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, 5, '计算�?, 11, '1', '2023-11-16 23:22:46', '1', '2023-11-16 15:47:09', '1', 1);
...
INSERT INTO yudao_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (11, 5, '计算�?, 11, '1', '2023-11-16 23:22:46', '1', '2024-09-17 10:55:28', '1', 1);
...
INSERT INTO yudao_demo03_course (id, student_id, name, score, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (16, 5, '计算�?, 11, '1', '2023-11-16 23:22:46', '1', '2024-09-17 18:55:29', '0', 1);
...
COMMENT ON COLUMN yudao_demo03_grade.teacher IS '班主�?;
COMMENT ON COLUMN yudao_demo03_grade.creator IS '创建�?;
COMMENT ON COLUMN yudao_demo03_grade.create_time IS '创建时间';
COMMENT ON COLUMN yudao_demo03_grade.updater IS '更新�?;
...
COMMENT ON TABLE yudao_demo03_grade IS '学生班级�?;
...
-- @formatter:off
BEGIN;
INSERT INTO yudao_demo03_grade (id, student_id, name, teacher, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (7, 2, '三年 2 �?, '周杰�?, '1', '2023-11-16 23:21:49', '1', '2024-09-17 18:55:31', '0', 1);
...
COMMENT ON COLUMN yudao_demo03_student.description IS '简�?;
COMMENT ON COLUMN yudao_demo03_student.creator IS '创建�?;
COMMENT ON COLUMN yudao_demo03_student.create_time IS '创建时间';
COMMENT ON COLUMN yudao_demo03_student.updater IS '更新�?;
...
COMMENT ON TABLE yudao_demo03_student IS '学生�?;
...
INSERT INTO yudao_demo03_student (id, name, sex, birthday, description, creator, create_time, updater, update_time, deleted, tenant_id) VALUES (9, '小花', 1, '2023-11-07 00:00:00', '<p>哈哈�?/p>', '1', '2023-11-17 00:04:47', '1', '2025-04-19 10:49:04', '0', 1);
COMMIT;
-- @formatter:on
